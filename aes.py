...
plaintext = "bonjour ca va ..".encode('hex')
...
#effectue l'expansion de la clé ( key est la clé du chiffreur et 	w est la clé résultante 
...
# effectue l'opération l'inverse de shiftrows
...
# effectue l'opération l'inverse de Sub_byte

def InvSubBytes(state):
    return [[isbox[byte] for byte in word] for word in state]

# effectue l'opération l'inverse de mixColumns
...
def AES_128():
    ...
    print (str(str_block_line(block)).decode('hex'))
    print("\n")
...
print ("INDICATION:")
print("pour tester AES 128 AES TAPEZ sage: test[128]() ")
print("pour tester AES 192 AES TAPEZ sage: test[192]()")
print("pour tester AES 256 AES TAPEZ sage: test[256]()")

test = {128 : AES_128,192 : AES_192,256 : AES_256,}
